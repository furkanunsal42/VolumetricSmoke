...
public class NavierStokesSolver : MonoBehaviour    // referance paper : https://www.dgp.toronto.edu/public_user/stam/reality/Research/pdf/GDC03.pdf
{
    public static HashSet<NavierStokesSolver> all_instances = new HashSet<NavierStokesSolver>();
    ...
    public NavierStokesSolver(Vector3Int size, float dt, int iterations, float diffusion, float viscosity)
    {
